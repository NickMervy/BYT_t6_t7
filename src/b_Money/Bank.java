...
public class Bank {
	...
	public void deposit(String accountid, Money money) throws AccountDoesNotExistException {
		// BUG#2: should throw if the account does not exist
		if (!accountlist.containsKey(accountid)) {
	...
	public void transfer(String fromaccount, String toaccount, Money amount) throws AccountDoesNotExistException {
		// BUG#4 shoud be toaccount parameter
	 ...
	 * @param toaccount Id of receiving account
	 */
	public void addTimedPayment(String accountid,
			String payid,
			Integer interval,
			Integer next,
			Money amount,
			Bank tobank,
			String toaccount) throws AccountDoesNotExistException {
		// BUG#5 should throw exception
